export type RejectDocTemplateParams = {
  firstName: string;
  lastName: string;
  reason?: string;
  appUrl: string;
...
export function rejectDocTemplate({
  firstName,
  lastName,
  appUrl,
}: RejectDocTemplateParams) {
  return `
    ...
    <table width="100%" cellspacing="0" cellpadding="0" class="es-wrapper" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px;padding:0;Margin:0;width:100%;height:100%">
        ...
        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" esdevVmlButton href="${appUrl}" style="height:54px; v-text-anchor:middle; width:330px" arcsize="15%" stroke="f"  fillcolor="#a80689">
