      ...
      try {
        ...
        if (positionId) {
          ...
          if (position) {
            ...
            const apiJob = positionToJobWithStaff(position, staffList);
            setJob(apiJob as ExtendedJob);
          }
        }
      } catch (error) {
          ...
          <div className="mb-6">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-start gap-3">
                ...
                <span className="text-gray-600">
                  {job.supervisorEmail || "ยังไม่ระบุ"}
                </span>
              </div>
              <div className="flex items-start gap-3">
                <svg
                ...
                <span className="text-gray-600">
                  {job.supervisorPhone || "ยังไม่ระบุ"}
                </span>
              </div>
            </div>
          </div>
