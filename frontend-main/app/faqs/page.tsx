    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 md:py-12">
        ...
        <div className="flex flex-col gap-8 md:gap-10">
          <FAQSection icon={<DocumentIcon />} title="FAQ นักศึกษาฝึกงาน">
            ...
            <FAQItem question="กฟภ. รับนักศึกษาระดับไหนบ้าง?">
              <div className="space-y-3">
                <ul className="list-disc list-inside space-y-1 ml-2">
                  <li>ระดับประกาศนียบัตรวิชาชีพ (ปวช.)</li>
                  <li>ระดับประกาศนียบัตรวิชาชีพชั้นสูง (ปวส.)</li>
                  <li>ระดับปริญญาตรี</li>
                  <li>ระดับมัธยมศึกษาตอนปลาย</li>
                </ul>
                <p>
                  ทั้งนี้
                  นักศึกษาจะต้องมีหนังสือขอความอนุเคราะห์จากสถาบันการศึกษา
                  หากไม่มีเอกสารดังกล่าว จะไม่สามารถสมัครเข้าฝึกงานได้
                </p>
              </div>
            </FAQItem>

            <FAQItem question="เอกสารสัญญาการรักษาความลับ สามารถเซ็นออนไลน์ได้หรือไม่?">
              <p>
                ไม่สามารถเซ็นออนไลน์ได้
                ต้องเป็นลายเซ็นจริงจากอาจารย์ของสถาบันเท่านั้น
                และต้องจัดส่งเป็นเอกสารตัวจริงจำนวน 2 ชุด (ไม่ใช้สำเนา)
              </p>
            </FAQItem>

            <FAQItem question="หนังสือยินยอมใช้จำนวนกี่ชุด?">
              <div className="space-y-2">
                <p>ใช้จำนวน 1 ชุด</p>
                <p>
                  เอกสารนี้ใช้ในกรณีที่หน่วยงานมีความจำเป็นต้องพานักศึกษาออกนอกสถานที่ในเวลาทำการ
                  โดยเอกสารดังกล่าวสามารถลงนามแบบออนไลน์ได้
                </p>
              </div>
            </FAQItem>

            <FAQItem question="หนังสือยินยอมจากสถาบัน สามารถให้อาจารย์ที่ปรึกษาลงนามแทนหัวหน้าภาควิชาได้หรือไม่?">
              <p>
                สามารถดำเนินการได้
                โดยให้อาจารย์ที่ปรึกษาลงนามแทนหัวหน้าภาควิชาได้
              </p>
            </FAQItem>

            <FAQItem question="กรณีอยู่ต่างจังหวัด สามารถสมัครฝึกงานในแต่ละเขตได้หรือไม่?">
              <p>
                ปัจจุบันระบบการรับสมัครยังไม่รองรับในระดับต่างจังหวัด
                โดยจะเปิดรับเฉพาะในส่วนของสำนักงานใหญ่เท่านั้น
              </p>
            </FAQItem>

            <FAQItem question="หนังสือรับรองการฝึกงานสามารถขอได้จากที่ใด?">
              <p>
                นักศึกษาสามารถติดต่อขอเอกสารได้จากกอง/หน่วยงานที่เข้าฝึกงานโดยตรง
                ซึ่งหน่วยงานนั้นจะเป็นผู้ออกหนังสือรับรองให้
              </p>
            </FAQItem>

            <FAQItem question="กฟภ. มีรถรับส่งสำหรับนักศึกษาฝึกงานหรือไม่?">
              <div className="space-y-2">
                <p>มีบริการรถรับส่งสำหรับนักศึกษา</p>
                <p>
                  ทั้งนี้
                  รายละเอียดเส้นทางและเงื่อนไขการใช้บริการสามารถสอบถามเพิ่มเติมได้จากหน่วยงานที่เข้าฝึกงาน
                  และนักศึกษาจะต้องปฏิบัติตามกฎระเบียบและข้อกำหนดของหน่วยงานอย่างเคร่งครัด
                </p>
              </div>
            </FAQItem>

            <FAQItem question="หลังจากฝึกงานเสร็จ ต้องส่งบัตรนักศึกษาที่ไหน?">
              <p>
                ให้นำบัตรนักศึกษามาส่งคืนที่สถานที่เดิมที่รับบัตร
                โดยส่งคืนที่อาคาร 6 ชั้น 3
              </p>
            </FAQItem>
          </FAQSection>
        </div>
