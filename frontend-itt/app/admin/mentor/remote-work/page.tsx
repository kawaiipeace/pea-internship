    ...
    return (
        <div className="min-h-screen bg-white dark:bg-black p-4 sm:p-6 -m-4 sm:-m-6 pb-20">
            ...
            <div className="mx-auto w-full max-w-[892px] flex flex-col gap-6">
                ...
                <FilterSection
                    onAddClick={() => router.push('/admin/mentor/remote-work/form')}
                ...
                <RemoteWorkList
                    tasks={tasks}
                    isLoading={isLoading}
                    onCardClick={(id) => router.push(`/admin/mentor/remote-work/${id}`)}
                    onEditClick={(e, id) => {
                        e.stopPropagation();
                        router.push(`/admin/mentor/remote-work/form?id=${id}`);
                    }}
                />
